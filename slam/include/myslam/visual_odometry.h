...
protected:  
    ...
    double getViewAngle( Frame::Ptr frame, MapPoint::Ptr point );
     PointCloud::Ptr createPointCloud(Frame::Ptr frame,Camera::Ptr camera);
    PointCloud::Ptr joinPointCloud( PointCloud::Ptr original, Frame::Ptr newFrame, Eigen::Isometry3d T, Camera::Ptr camera ) ;
